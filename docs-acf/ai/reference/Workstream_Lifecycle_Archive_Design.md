...
5. 不自动修改 [active/Context.md](../active/Context.md)、[active/Current_Task.md](../active/Current_Task.md) 或 Task Plan。
...
6. `workstream sync` 只更新 [active/Workstreams.md](../active/Workstreams.md)，不移动详情文件，不删除缺详情旧行。
...
6. [active/Current_Task.md](../active/Current_Task.md) 的 `## 当前执行线` 没有引用该 Workstream。
7. [active/Task_Plan.md](../active/Task_Plan.md) 当前焦点不是直接要求该 Workstream 作为当前解释线。
...
3. [active/Current_Task.md](../active/Current_Task.md) 当前执行线引用该 Workstream。
...
6. 自动删除 [active/Workstreams.md](../active/Workstreams.md) 中对应行，并重算 `## Workstream 状态`。
7. 自动写入 [archive/Archive_Index.md](../archive/Archive_Index.md)。
8. 自动在归档详情末尾追加 `ACF:WORKSTREAM:ARCHIVE-RECORD` marker block。
9. 不修改 merge target，不修改 [active/Context.md](../active/Context.md)、[active/Current_Task.md](../active/Current_Task.md)、[active/Task_Plan.md](../active/Task_Plan.md)。
10. 如果 [active/Workstreams.md](../active/Workstreams.md) 缺少该 ID 行，warning 后继续；如果有重复行，失败。
...
[archive/Archive_Index.md](../archive/Archive_Index.md) 使用通用 7 列表头：
