...
1. 实现脚本并运行三条主路径。
2. 产出并验证输出物：短、透明、少封装的本地 smoke runner 脚本与验证记录

---

## 任务背景

该任务来自 `active/Task_Plan.md` 中的子任务 T001，所属大任务为“最小 smoke runner 设计与实现”。依赖记录：无明确依赖。
...
- 短、透明、少封装的本地 smoke runner 脚本与验证记录

---

## 成功标准

1. 输出物已完成：短、透明、少封装的本地 smoke runner 脚本与验证记录
