...
1. Add ARCHIVE marker constants, row collection, sync command, parser wiring, tests, and docs
2. 产出并验证输出物：archive sync command, tests, docs, and dogfooding marker

---

## 任务背景

该任务来自 `active/Task_Plan.md` 中的子任务 T001，所属大任务为“Archive Sync MVP”。依赖记录：无明确依赖。
...
- archive sync command, tests, docs, and dogfooding marker

---

## 成功标准

1. 输出物已完成：archive sync command, tests, docs, and dogfooding marker
