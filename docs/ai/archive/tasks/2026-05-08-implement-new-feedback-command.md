...
Implement new feedback command
...
1. 完成子任务 T001。
2. 产出并验证输出物：new feedback CLI, tests, docs, smoke, version

---

## 任务背景

该任务来自 `active/Task_Plan.md` 中的子任务 T001，所属大任务为“Feedback Entry CLI”。依赖记录：无明确依赖。
...
- `active/Task_Plan.md`。
- `active/Context.md`。
- [reference/System_Manual.md](../../reference/System_Manual.md)：Feedback_Inbox 生命周期和事实源边界。

---

## 输出要求

- new feedback CLI, tests, docs, smoke, version

---

## 成功标准

1. 输出物已完成：new feedback CLI, tests, docs, smoke, version
