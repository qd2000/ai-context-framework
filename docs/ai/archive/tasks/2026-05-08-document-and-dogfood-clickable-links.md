...
- 当前阶段目标请查看：[active/Context.md](../../active/Context.md)
- 本文件只维护当前具体任务
...
该任务来自 [active/Task_Plan.md](../../active/Task_Plan.md) 中的子任务 T003，所属大任务为“P2-7 Markdown Link Traceability”。依赖记录：T002

---

## 输入材料

当前任务应列出必要 active 文件和相关 reference 规划依据；不要只写 [active/Context.md](../../active/Context.md)。
...
1. 遵守当前项目规则和默认读取顺序。
2. 保持 [active/Task_Plan.md](../../active/Task_Plan.md) 与 [active/Current_Task.md](../../active/Current_Task.md) 状态同步。
...
1. 应写入 [active/Context.md](../../active/Context.md) 的新增当前事实。
