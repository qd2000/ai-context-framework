...
- `active/Task_Plan.md`。
- `active/Context.md`。
- [archive/plans/2026-09-18-ws013-observer-retirement-and-v0.0.3.92-plan.md](../plans/2026-09-18-ws013-observer-retirement-and-v0.0.3.92-plan.md)：WS013 Observer 退役、WS012 收尾、验证矩阵与 v0.0.3.92 发布路线（第 4 节 P7 与第 7 节成功标准）。
