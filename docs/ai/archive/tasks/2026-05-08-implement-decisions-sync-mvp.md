...
1. Add DECISIONS marker constants, row collection, sync command, and parser wiring
2. 产出并验证输出物：decisions sync command and marker integration

---

## 任务背景

该任务来自 `active/Task_Plan.md` 中的子任务 T001，所属大任务为“Decisions Sync MVP”。依赖记录：无明确依赖。
...
- decisions sync command and marker integration

---

## 成功标准

1. 输出物已完成：decisions sync command and marker integration
