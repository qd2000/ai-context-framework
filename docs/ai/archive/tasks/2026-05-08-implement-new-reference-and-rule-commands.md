...
Implement new reference and rule commands
...
1. 完成子任务 T001。
2. 产出并验证输出物：new reference/rule CLI, tests, docs, version, dogfooding verification

---

## 任务背景

该任务来自 `active/Task_Plan.md` 中的子任务 T001，所属大任务为“Safe Context Object Creation CLI”。依赖记录：无明确依赖。
...
- new reference/rule CLI, tests, docs, version, dogfooding verification

---

## 成功标准

1. 输出物已完成：new reference/rule CLI, tests, docs, version, dogfooding verification
