...
| ----- | ---- | -------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | -------------------------------- | --------------------------------------------------- |
| WS007 | ReadyToMerge | Continuation orphan recovery, fencing and durable reconciliation | codex | assigned: active/workstreams/WS007.md, shared: active/Workstreams.md, assigned: ai_context_framework/commands/continuation.py, assigned: ai_context_framework/commands/log.py, assigned: ai_context_framework/continuation_rounds.py, shared: ai_context_framework/runtime.py, assigned: tests/test_continuation_cli.py, shared: README.md, shared: CHANGELOG.md, shared: docs/**, shared: pyproject.toml, shared: ai_context_framework/version.py, shared: uv.lock, shared: ai_context_framework.egg-info/**, assigned: ai_context_framework/continuation_recovery.py |  | Continuation v2 orphan recovery, fencing, durable side-effect reconciliation, tests, migration docs, and release candidate | active/workstreams/WS007.md |
