...
| ----- | ---- | -------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | -------------------------------- | --------------------------------------------------- |
| WS006 | Open | 默认全局上下文与显式 Workstream 选择 | codex | assigned: active/workstreams/WS006.md, shared: active/Workstreams.md, assigned: ai_context_framework/commands/status_check.py, shared: ai_context_framework/runtime.py, assigned: tests/**, shared: README.md, shared: CHANGELOG.md, shared: docs/**, shared: template/**, shared: pyproject.toml, shared: ai_context_framework.egg-info/** | 无。 | 默认全局上下文路由、显式选择与冲突检测、渐进式披露合同、测试和发布证据 | active/workstreams/WS006.md |
