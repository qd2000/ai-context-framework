...
| T005 | Pending | 用户旅程摩擦点整理 | T002,T003,T004 | AI 友好性、错误恢复和不常见场景摩擦清单 | 无。 | 整理 T001-T004 使用旅程摩擦点，包括并发读写撞锁后疑似 .acf.lock 运行态残留的观察；判断是否需要自动清理、gitignore 或文档提示，并评估是否进入最小 smoke runner。 |
