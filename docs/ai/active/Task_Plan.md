...
| T005 | Active | Workstream index consistency check, then sync | T004 | Workstreams 索引一致性检查；后续 sync dry-run | PR 4a complete: acf.py; tests/test_cli.py; README.md; template/reference/System_Manual.md; docs/ai/reference/Workstream_Design.md; docs/ai/reference/System_Manual.md; docs/Automation.md; worklog/daily/2026-05-06.md; verification: targeted PR4a tests, unittest, check template, strict docs check, upgrade dry-run, minimal smoke, quick upgrade matrix, py_compile | PR 4b：新增 acf workstream sync --dry-run --json，只更新 active/Workstreams.md。 |
