...
| T007 | Done | Authority path 前缀归一化补强 | T006 | Workstream assigned/owned claim docs/ai 前缀 authority path 时被 strict check 拒绝 | acf.py; tests/test_cli.py; worklog/daily/2026-05-06.md; verification: targeted authority tests, py_compile, check template, strict docs check, upgrade dry-run, unittest, minimal smoke, quick upgrade matrix, FCC strict check | 无。 |
