"""Bounded user-level Observer filesystem, history, and lock primitives.

This module deliberately contains no Writer/control-plane operations.  It
keeps the low-level runtime persistence surface separate from semantic and
Dashboard rendering logic while preserving the public imports historically
re-exported by :mod:`ai_context_framework.observer_storage`.
"""
